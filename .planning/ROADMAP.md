...
- [x] 15-03-PLAN.md — Frontend UI: TelemetrySection Hue subsection, HueFaultSimulator dev tool
...
Plans:
- [x] 16-01-PLAN.md — Mode toggle, single-channel drag, coordinate tooltip, i18n keys
- [x] 16-02-PLAN.md — Multi-select, group drag, z-axis detail strip, persistence wiring
...
**Requirements**: ROOM-01, ROOM-02, ROOM-04, ROOM-05, ROOM-06, ROOM-07, ROOM-08
**Note**: ROOM-03 (named zone creation and light assignment) moved to Phase 19 — zone UI belongs with zone auto-derivation workflow.
**Success Criteria** (what must be TRUE):
...
- [x] 18-02-PLAN.md — Frontend target-aware mode pipeline, hot-plug UX, startup filtering, i18n
...
**Depends on**: Phase 17
**Requirements**: ZONE-01, ZONE-02, ZONE-03, ROOM-03
**Success Criteria** (what must be TRUE):
...
- [x] 19-02-PLAN.md — Zone derive preview overlay, toolbar integration, calibration transfer
...
| 19. LED Zone Auto-Derivation | v1.2 | 2/3 | In Progress|  |
