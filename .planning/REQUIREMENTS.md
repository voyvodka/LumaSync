...
- [x] **ROOM-01**: User can create a 2D top-down room map with configurable room dimensions (width x depth in meters)
...
### Hue Kanal Pozisyon Editoru (CHAN)
...
### LED Zone Otomatik Turetme (ZONE)
...
| Feature | Reason |
|---------|--------|
| Isometric / 3D room renderer | 2-3x dev cost, WebGL WebView2 risks, 2D top-down is sufficient for zone derivation |
...
- Phase 17 (Room Map UI): ROOM-01, ROOM-02, ROOM-04, ROOM-05, ROOM-06, ROOM-07, ROOM-08
- Phase 18 (Hue Standalone Mode): STND-01, STND-02, STND-03
- Phase 19 (LED Zone Auto-Derivation): ZONE-01, ZONE-02, ZONE-03, ROOM-03
