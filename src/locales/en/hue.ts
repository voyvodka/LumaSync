export default {
  ...
  channelMap: {
    ...
    identify: "Identify",
    identifying: "Blinking...",
    identifyAriaLabel: "Identify channel {{index}}: blink its light once",
    identifyBlocked: "Stop Hue first. A light cannot be identified while Hue streams to it.",
    identifyPartial: "Some of the lights did not blink.",
    identifyFailed: "The light did not blink. Check that the bridge is reachable and try again.",
    saveError: "Placement not saved — store error. Try it again.",
    saveToBridge: "Save positions to bridge",
    streamingNote: "Stop Hue to save or take positions, or to identify a light. The bridge does not change positions while it streams.",
    saving: "Saving...",
  ...
  page: {
    ...
    forgetConfirm: {
      ...
      body: "Hue stops and leaves your outputs, and the pairing and its key are removed from this computer. Your room map keeps its Hue lights. The bridge still lists LumaSync among its authorised apps, and only your Hue account can remove it: sign in at account.meethue.com/apps.",
      confirm: "Forget bridge",
    },
    forgetResult: {
      ok: "Bridge forgotten. To remove LumaSync from the bridge as well, sign in at account.meethue.com/apps and remove it there.",
      partial: "Bridge forgotten, but something was left behind. To remove LumaSync from the bridge as well, use account.meethue.com/apps.",
      failed: "The bridge was not forgotten. Nothing was changed.",
    },
