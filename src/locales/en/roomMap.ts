export default {
  ...
  settings: {
    ...
    roomDepth: "Depth (m)",
    roomHeight: "Height (m)",
    roomHeightHint: "Floor to ceiling. Sets how high Hue lights sample the screen.",
    resetMap: "Reset map",
    resetMapConfirm: "Confirm reset?",
    resetMapHint: "Clears the TV, furniture and images. Strips connected in Devices and your Hue lights stay.",
  },
  ...
  objectPanel: {
    ...
    unlock: "Unlock",
    delete: "Delete",
    dockAriaLabel: "Room map dock — switch between the Objects and Hue Zones tabs",
  },
  inspector: {
    ...
    zoneSize: "Size",
    hueHeightZoneLimit: "Limited by zone {{name}} ({{min}}–{{max}} m). Move the light out of the zone to place it outside that range.",
    zoneEdgeShort: "Edge",
