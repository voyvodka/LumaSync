export default {
  ...
  status: {
    ...
    connectingBody: "Opening {{port}} and checking the controller. This takes a few seconds.",
    ...
    hints: {
      ...
      recoveryCancelled: "Automatic reconnect stopped: the port you chose is used instead.",
  ...
  page: {
    ...
    wled: {
      ...
      status: {
        ...
        testLiveConfirmed: "Test frame shown — the device confirmed it is displaying LumaSync.",
        testSentUnconfirmed: "Test frame sent, but the device did not confirm it is showing it. Check whether the LEDs flashed red.",
        realtimePortMismatch: "The device listens for live data on a different port. Check its Sync settings in WLED.",
