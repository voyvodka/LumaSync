  ...
  page: {
    ...
    wled: {
      ...
      status: {
        ...
        testLiveConfirmed: "Test karesi gösterildi — cihaz LumaSync'i gösterdiğini doğruladı.",
        testSentUnconfirmed: "Test karesi gönderildi ama cihaz gösterdiğini doğrulamadı. LED'lerin kırmızı yanıp yanmadığına bak.",
        realtimePortMismatch: "Cihaz canlı veriyi başka bir portta dinliyor. WLED'deki Sync ayarlarını kontrol et.",
