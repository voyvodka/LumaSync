...
export const SCENE_PRESETS: readonly ScenePreset[] = [
  {
    id: "movie",
    labelKey: "common:compact.scenes.movie",
  ...
  {
    id: "game",
    labelKey: "common:compact.scenes.game",
  ...
  {
    id: "music",
    labelKey: "common:compact.scenes.music",
  ...
  {
    id: "chill",
    labelKey: "common:compact.scenes.chill",
  ...
  {
    id: "read",
    labelKey: "common:compact.scenes.read",
