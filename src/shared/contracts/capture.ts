/** Reasons riding `status.details` on `AMBILIGHT_MODE_START_FAILED`, never codes of
 *  their own. `LED_OUTPUT_PORT_UNAVAILABLE` shares the field without being one. */
...
/** What the user can do about it — 17 reasons, 6 buckets, because 13 are log-only. */
