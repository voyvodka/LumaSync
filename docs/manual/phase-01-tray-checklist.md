...
**Prerequisites:** Run `bun run tauri dev` and ensure the app launches.  
...
- [ ] `bun run tauri dev` starts without build errors
...
- [ ] With app running, attempt to launch a second instance (run `bun run tauri dev` again or open built binary)
